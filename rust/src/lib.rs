//! Windissect-generated Rust FFI bindings for shlwapi.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "051A357CE7C64FB00F70687E592FBA52";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3126288724;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 12] = [115, 104, 108, 119, 97, 112, 105, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3126288724 { return 0; }
