...
|---|---|---|---|---|
| `push_back<unsigned char>` | `bool` | `Method` | `Pdb` | No (PDB) |
| `push_back<enum tson::details::archive_marker>` | `bool` | `Method` | `Pdb` | No (PDB) |
| `push_back` | `bool` | `Method` | `Pdb` | No (PDB) |
| `reserve` | `bool` | `Method` | `Pdb` | No (PDB) |
| `set_position` | `void` | `Method` | `Pdb` | No (PDB) |
