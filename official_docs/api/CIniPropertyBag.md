# `global` :: `CIniPropertyBag`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `shlwapi.dll`. Total members: **7**.
...
|---|---|---|---|---|
| `CIniPropertyBag` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CIniPropertyBag` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `_GetSectionAndName` | `long` | `Method` | `Pdb` | No (PDB) |
