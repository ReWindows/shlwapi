# `global` :: `CDesktopUpgradePropertyBag`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `shlwapi.dll`. Total members: **8**.
...
|---|---|---|---|---|
| `CDesktopUpgradePropertyBag` | `void` | `Ctor` | `Pdb` | No (PDB) |
...
| `_GetOldDesktopViewStream` | `struct IStream *` | `Method` | `Pdb` | No (PDB) |
| `_NewStreamFromOld` | `struct IStream *` | `Method` | `Pdb` | No (PDB) |
| `_ReadFlags` | `long` | `Method` | `Pdb` | No (PDB) |
