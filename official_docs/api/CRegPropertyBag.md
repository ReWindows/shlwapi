...
| `_WriteStream` | `long` | `Method` | `Pdb` | No (PDB) |
| `_CopyStreamIntoBuff` | `long` | `Method` | `Pdb` | No (PDB) |
| `_GetStreamSize` | `long` | `Method` | `Pdb` | No (PDB) |
| `_ReadBinary` | `long` | `Method` | `Pdb` | No (PDB) |
| `_ReadULONGLONG` | `long` | `Method` | `Pdb` | No (PDB) |
