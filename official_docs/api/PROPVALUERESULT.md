# `global` :: `PROPVALUERESULT`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `shlwapi.dll`. Total members: **3**.
...
public:
    ...
    // Symbol: ??0PROPVALUERESULT@@QEAA@XZ
    PROPVALUERESULT();
    // Category: Dtor | Source: PDB Internal
    // Symbol: ??1PROPVALUERESULT@@QEAA@XZ
    ~PROPVALUERESULT();
};
...
|---|---|---|---|---|
| `PROPVALUERESULT` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~PROPVALUERESULT` | `void` | `Dtor` | `Pdb` | No (PDB) |
