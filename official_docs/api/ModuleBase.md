...
Reconstructed from `shlwapi.dll`. Total members: **5**.
...
|---|---|---|---|---|
| `GetFirstEntryPointer` | `struct Microsoft::WRL::Details::CreatorMap const * *` | `Accessor` | `Pdb` | No (PDB) |
| `GetObjectCount` | `unsigned long` | `Accessor` | `Pdb` | No (PDB) |
| `GetLastEntryPointer` | `struct Microsoft::WRL::Details::CreatorMap const * *` | `Accessor` | `Pdb` | No (PDB) |
| `GetLock` | `struct _RTL_SRWLOCK *` | `Accessor` | `Pdb` | No (PDB) |
| `GetMidEntryPointer` | `struct Microsoft::WRL::Details::CreatorMap const * *` | `Accessor` | `Pdb` | No (PDB) |
