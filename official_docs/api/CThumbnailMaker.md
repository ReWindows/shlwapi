# `global` :: `CThumbnailMaker`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `shlwapi.dll`. Total members: **6**.
...
|---|---|---|---|---|
| `~CThumbnailMaker` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `AddDIBSECTION` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetBITMAPINFO` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetSharpenedBITMAPINFO` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `Init` | `long` | `Method` | `Pdb` | No (PDB) |
| `Scale` | `long` | `Method` | `Pdb` | No (PDB) |
