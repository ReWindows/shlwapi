...
static constexpr wchar_t module_name[12] = {0x0073, 0x0068, 0x006C, 0x0077, 0x0061, 0x0070, 0x0069, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 3126288724U || rva >= image_size) return nullptr;
return base + rva;
}
